...
const ProductManager = () => {
  ...
  const handleUploadInput = e => {
    ...
    if(files.length === 0) 
    return err = dispatch({type: 'NOTIFY', payload: {error: 'Files does not exist.'}})
  ...
  return(
    <div className= "product_manager">
        ...
        <div className= "col-md-6">
          ...
          <div className= "row">
            ...
            <div className= "col-sm-6">
              ...
              placeholder= "inStock" className= "d-block my-4 w-100 p-2"
              onChange= {handleChangeInput} />
            </div>
          </div>
      ...
      <button type="submit" className= "btn btn-info my-2 px-4">Create</button>
